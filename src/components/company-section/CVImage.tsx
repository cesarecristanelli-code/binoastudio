...
export default function CVImage() {
  ...
  const data = {
    right: {
      name: "Pietro",
      desc: `Pietro Bonetto è l'anima dinamica di BINÒA. 
    ...
    left: {
      name: "Andrea",
      desc: `Andrea Cristanelli è l'anima tecnica di BINÒA. 
  ...
  return (
    <section className="relative w-full h-[50vh] md:h-[80vh] min-h-125 overflow-hidden bg-gray-900 group">
      ...
      <Image
        src="/andrea-tyron.png"
        alt="Andrea e Tyron"
        fill
        className="absolute inset-0 w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105"
      />

      {/* 2. Layout a due Colonne: ora ho impostato che se schiaccio su andrea si  */}
