...
export default function Footer() {
    return (
        <section className={`mt-auto bg-slate-900/80 text-gray-300 flex flex-col justify-center items-center pt-10 pb-5 px-5 border border-gray-800 leading-relaxed`}>
